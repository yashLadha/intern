...
var BrowserStackTunnel = (function (_super) {
    tslib_1.__extends(BrowserStackTunnel, _super);
    ...
    BrowserStackTunnel.prototype._start = function (executor) {
        ...
        return this._makeChild(function (child, resolve, reject) {
          ...
          process.emitWarning('Local is starting.....');
    ...
    BrowserStackTunnel.prototype._stop = function () {
        ...
        return new Promise(function (resolve) {
          // Enables a setTimeout for killing a binary that kills the connection
          // Donot kill the binary for some certain period of time
          setTimeout(function() {
            ...
            process.emitWarning('Local is getting killed outside');

            setTimeout(function () {
              if (!exited) {
                process.emitWarning('Local is getting killed inside');
